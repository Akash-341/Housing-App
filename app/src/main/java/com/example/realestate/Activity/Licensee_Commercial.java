...
public class Licensee_Commercial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_licensee_commercial);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(Licensee_Commercial.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isAllFieldsChecked) {
                    addnew(name.getText().toString(), mob1.getText().toString(), mob2.getText().toString(), remarks.getText().toString(), type.getText().toString(), date.getText().toString());
                }
            }
        });
    }
    ...
    private void addnew(String name,String mob1,String mob2,String remarks,String type,String date) {
        ProgressDialog pDialog = new ProgressDialog(this);
        pDialog.setMessage("Loading...PLease wait");
        pDialog.show();

        StringRequest stringRequest=new StringRequest(Request.Method.POST, AllUrl.LICENSEE_COMMERCIAL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    JSONObject jsonObject=new JSONObject(response);
                    Log.e( "JsonObject ",jsonObject.toString() );
                    Toast.makeText(Licensee_Commercial.this,jsonObject.getString("Msg"),Toast.LENGTH_SHORT).show();
                    pDialog.dismiss();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Licensee_Commercial.this,"Error",Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
