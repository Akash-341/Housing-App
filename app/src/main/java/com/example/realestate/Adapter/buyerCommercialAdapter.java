...
public class buyerCommercialAdapter extends RecyclerView.Adapter<buyerCommercialAdapter.ViewHolder> {
    private List<BuyerCommercialModel> buyerCommercialModelList=new ArrayList<>();
    Context context;

    public buyerCommercialAdapter(List<BuyerCommercialModel> buyerCommercialModelList, Context context) {
        this.buyerCommercialModelList = buyerCommercialModelList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.buyer_commercial_entries, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        BuyerCommercialModel bcm=buyerCommercialModelList.get(position);
        holder.date.setText(bcm.getDate());
        holder.name.setText(bcm.getName());
        holder.location.setText(bcm.getLocation());
        holder.type.setText(bcm.getType());
        holder.mob1.setText(bcm.getMob1());
        holder.mob2.setText(bcm.getMob2());
    ...
    public int getItemCount() {
        return buyerCommercialModelList.size();
    }
