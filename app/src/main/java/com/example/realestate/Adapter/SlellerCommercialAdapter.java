...
public class SlellerCommercialAdapter extends RecyclerView.Adapter<SlellerCommercialAdapter.viewHolder> {

    private List<RecentEntriesModel> recentEntriesModelList=new ArrayList<>();
    Context context;

    public SlellerCommercialAdapter(List<RecentEntriesModel> recentEntriesModelList, Context context) {
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        TextView name,flatno ,date,building,location,type,area,mob1,mob2,price,remarks,cr,le;
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            cr=itemView.findViewById(R.id.tvCR);
            le=itemView.findViewById(R.id.tvLE);
